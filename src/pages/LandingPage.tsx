    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/login">
              <Button
                variant="ghost"
                className="text-slate-300 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10"
              >
                Sign In
              </Button>
            </Link>
            <Link to="/register">
              <Button className="bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-500 hover:via-purple-500 hover:to-pink-500 shadow-2xl shadow-purple-500/50 hover:shadow-purple-500/70 transition-all hover:scale-105">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <section className="container mx-auto px-6 py-24 text-center relative z-10">
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="flex items-center justify-center gap-6 flex-wrap animate-fade-in-up animation-delay-400">
            <Link to="/register">
              <Button
                size="lg"
                className="bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-500 hover:via-purple-500 hover:to-pink-500 text-xl px-12 py-8 shadow-2xl shadow-purple-500/50 hover:shadow-purple-500/80 hover:scale-105 transition-all duration-300 font-semibold"
              >
            ...
            <Link to="/login">
              <Button
                size="lg"
                variant="outline"
                className="text-xl px-12 py-8 border-slate-700 bg-slate-900/50 hover:bg-slate-800/80 backdrop-blur-xl hover:scale-105 transition-all duration-300 hover:border-slate-600 font-semibold"
              >
                Sign In
              </Button>
            </Link>
        ...
        <div className="max-w-5xl mx-auto mt-24 animate-fade-in-up animation-delay-800">
          <Card className="p-3 shadow-2xl shadow-purple-500/30 bg-slate-950/80 backdrop-blur-2xl border border-slate-800/50 hover:border-purple-500/50 transition-all duration-500 group">
            <div className="flex items-center gap-5 bg-black/50 rounded-2xl px-8 py-6 border border-slate-800/50 group-hover:border-purple-500/50 transition-all group-hover:shadow-lg group-hover:shadow-purple-500/20">
              <Search className="w-7 h-7 text-slate-600 group-hover:text-purple-400 transition-colors" />
              <input
                type="text"
              ...
              <Button
                size="lg"
                className="bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-500 hover:via-purple-500 hover:to-pink-500 shadow-xl shadow-purple-500/50 px-6 py-3"
                disabled
              >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-center gap-6 flex-wrap">
              <Link to="/register">
                <Button
                  size="lg"
                  className="text-xl px-14 py-8 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-500 hover:via-purple-500 hover:to-pink-500 shadow-2xl shadow-purple-500/50 hover:shadow-purple-500/70 hover:scale-105 transition-all duration-300 font-semibold"
                >
                  Create Free Account
                  <ArrowRight className="ml-3 w-6 h-6" />
                </Button>
              ...
              <Link to="/login">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-xl px-14 py-8 bg-slate-900/50 hover:bg-slate-800/80 backdrop-blur-xl border-2 border-slate-700 hover:border-slate-600 hover:scale-105 transition-all duration-300 font-semibold"
                >
                  Sign In
                </Button>
              </Link>
